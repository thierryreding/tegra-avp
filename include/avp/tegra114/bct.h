#ifndef AVP_TEGRA114_BCT_H
#define AVP_TEGRA114_BCT_H
...
#define BCT_CUSTOMER_DATA_SIZE 720
...
struct bct_sdram_params {
	...
	uint32_t ch1_emc_dll_trim_txdqs0;
	uint32_t ch1_emc_dll_trim_txdqs1;
	uint32_t ch1_emc_dll_trim_txdqs2;
	uint32_t ch1_emc_dll_trim_txdqs3;
	uint32_t ch1_emc_dll_trim_txdqs4;
	uint32_t ch1_emc_dll_trim_txdqs5;
	uint32_t ch1_emc_dll_trim_txdqs6;
	uint32_t ch1_emc_dll_trim_txdqs7;
	...
	uint32_t ch1_emc_xm2clkpadctrl;
	uint32_t ch1_emc_xm2clkpadctrl2;
	uint32_t ch1_emc_xm2cmdpadctrl2;
	uint32_t ch1_emc_xm2cmdpadctrl3;
	uint32_t ch1_emc_xm2cmdpadctrl4;
	uint32_t ch1_emc_xm2dqpadctrl;
	uint32_t ch1_emc_xm2dqpadctrl2;
	uint32_t ch1_emc_xm2dqspadctrl;
	uint32_t ch1_emc_xm2dqspadctrl3;
	uint32_t ch1_emc_xm2dqspadctrl4;
} __packed;
